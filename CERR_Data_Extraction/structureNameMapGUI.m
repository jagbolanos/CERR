...
switch upper(command)
    ...
    case 'INIT'
        ...
        resultsH.results_frame2      = uicontrol(hFig,'style','frame','units',units,'position',[0.795 0.94 0.15 0.01],'foregroundColor',figureColor,'backgroundColor',figureColor);
        ...
        resultsH.doseNames_txt1      = uicontrol(hFig,'style','text','string','Doses to extract:','units',units,'position',[0.02 0.75 0.22 0.04],'fontWeight','bold','fontSize',8,'BackgroundColor', figureColor,'HorizontalAlignment','left');
        resultsH.doseNames_txt2      = uicontrol(hFig,'style','text','string','','units',units,'position',[0.25 0.74 0.7 0.06],'fontWeight','normal','fontSize',10,'BackgroundColor', figureColor,'HorizontalAlignment','left');
        resultsH.planNames_txt       = uicontrol(hFig,'style','text','string','File Names','units',units,'position',[0.04 0.62 0.25 0.04],'fontWeight','bold','fontSize',10,'BackgroundColor', figureColor,'HorizontalAlignment','left');
        resultsH.planNames_list      = uicontrol(hFig,'style','list','string','','units',units,'Min',1,'Max',1,'Value',1,'position',[0.05 0.07 0.25 0.53],'fontWeight','normal','fontSize',10,'BackgroundColor', figureColor,'HorizontalAlignment','left','callback','structureNameMapGUI(''fix_selected_plan'')');
        resultsH.allStruct_txt       = uicontrol(hFig,'style','text','string','Structures selected','units',units,'position',[0.34 0.62 0.25 0.04],'fontWeight','bold','fontSize',10,'BackgroundColor', figureColor,'HorizontalAlignment','left');
        resultsH.allStruct_list      = uicontrol(hFig,'style','list','string','','units',units,'Min',1,'Max',1,'Value',1,'position',[0.35 0.07 0.25 0.53],'fontWeight','normal','fontSize',10,'BackgroundColor', figureColor,'HorizontalAlignment','left');
        resultsH.allDoses_txt       = uicontrol(hFig,'style','text','string','Doses selected','units',units,'position',[0.64 0.62 0.25 0.04],'fontWeight','bold','fontSize',10,'BackgroundColor', figureColor,'HorizontalAlignment','left');
        resultsH.allDoses_list      = uicontrol(hFig,'style','list','string','','units',units,'Min',1,'Max',1,'Value',1,'position',[0.65 0.07 0.25 0.53],'fontWeight','normal','fontSize',10,'BackgroundColor', figureColor,'HorizontalAlignment','left');
        ...
        if exportFormatVal == 1 %DREES format
            ...
            for planNum=1:length(ud.newNameMapS)
                ...
                for j=1:length(ud.scanDir.strNamC)
                    if ~isempty(ud.newNameMapS(planNum).structMap{j}) && length(ud.newNameMapS(planNum).structMap{j}) == 1 && ~isempty(ud.newNameMapS(planNum).doseMap)
                        try
                            ...
                            warning(['Could not extract DVH for ', ud.newNameMapS(planNum).fullFileName])
                        end
