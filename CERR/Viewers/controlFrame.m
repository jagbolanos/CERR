    ...
    case 'contour'
        switch (varargin{1})
            case 'init'
                ...
                ud.handles.modePopup = uicontrol(hFig, 'style', 'popupmenu', 'units', units, 'position', absPos([.40 .40 .55 .05], posFrame), 'string', {'Draw', 'Edit', 'Threshold', 'Reassign'}, 'tag', 'controlFrameItem', 'callback', 'controlFrame(''contour'', ''selectMode'')', 'TooltipString', 'Select Mode. Shortcut Keys: ''D'', ''E'', ''T'', ''R''');
    ...
    case 'fusion'
        switch varargin{1}
            case 'init'
                ...
                fPos = get(gcf, 'pos');
                dPos1 = [fPos(3)-250 -404   0 0];
                dPos2 = [fPos(3)-250 -404+8 0 0];
                ...
                set(stateS.handle.buttonUp, 'pos', dPos2+tempbuttonUp);
                
                tempbuttonDwn = get(stateS.handle.buttonDwn, 'pos');
                ud.handle.buttonDwnPos = tempbuttonDwn;
                set(stateS.handle.buttonDwn, 'pos', dPos2+tempbuttonDwn);
                ...
                ud.handles.differToggle= uicontrol(hFig, 'style',  'togglebutton','units', units, 'position', absPos([.05 .34+dy .90 .05], posFrame),...
                ...
                ud.handles.newcheckerSize= uicontrol(hFig, 'style',  'slider','units', units, 'position', absPos([.30 .22+dy .65 .04], posFrame),...
                    'string', 'CB Size', 'tag', 'controlFrameItem', 'min', 2, 'max', 12, 'sliderstep', [0.1 0.2], 'value', 4, ...
