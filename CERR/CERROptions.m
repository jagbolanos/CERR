...
optS.DVHBinWidth = 0.05;       %Store and display DVHs with this width, in units of Gy.
...
optS.IVHBinWidth = .05;       %Store and display IVHs with this width, in units of Gy.
...
%--Color Map base scan----------------------------------------------------%
optS.scanColorMap = [struct('name', 'Gray') struct('name', 'copper') struct('name', 'Red') struct('name', 'Green') struct('name', 'Blue') struct('name', 'StarInterp')];
