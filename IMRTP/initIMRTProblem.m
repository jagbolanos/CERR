...
%JJW 07/05/06 - added support for sigma_100
%
%Usage:
%   function IM = initIMRTProblem
%
...
%IM = struct('beams','','goals','','beamlets','','solution','','params','','assocScanUID','');
IM = struct('beams','','goals','','solutions','','params','','assocScanUID','');
...
IM.beams  = struct(...
                 ...
                 'colPBV',[], ...
                 'sigma_100',[],...        %Gaussian blur of PBs at 100 cm. (in cm)
...
IM.params = struct(...
                    ...
                    'VMC', [], ...               %See below
                    'Scatter', [], ...          %See below             
                    'DoseTerm','' ...           % 'primary','primary+scatter','scatter','GaussPrimary', or 'GaussPrimary+scatter'
                    );
